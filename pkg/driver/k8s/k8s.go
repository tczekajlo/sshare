...
func (c *Client) createDeployment(data *pb.BackendData) error {
	...
	if err != nil {
		...
		metrics.BackendCreateErrorOpsTotal.WithLabelValues("deployment").Inc()
	...
	metrics.BackendCreateSuccessOpsTotal.WithLabelValues("deployment").Inc()
...
func (c *Client) createService(data *pb.BackendData) error {
	...
	if err != nil {
		...
		metrics.BackendCreateErrorOpsTotal.WithLabelValues("service").Inc()
	...
	metrics.BackendCreateSuccessOpsTotal.WithLabelValues("service").Inc()
...
func (c *Client) createIngress(data *pb.BackendData) error {
	...
	if err != nil {
		...
		metrics.BackendCreateErrorOpsTotal.WithLabelValues("ingress").Inc()
	...
	metrics.BackendCreateSuccessOpsTotal.WithLabelValues("ingress").Inc()
...
func (c *Client) Create(data *pb.BackendData, opts ...interface{}) error {
	...
	metrics.BackendCreateOpsTotal.Inc()
...
func (c *Client) Delete(data *pb.BackendData, opts ...interface{}) error {
	...
	if err != nil {
		...
		metrics.BackendDeleteErrorOpsTotal.WithLabelValues("service").Inc()

		return err
	}
	metrics.BackendDeleteSuccessOpsTotal.WithLabelValues("service").Inc()
	...
	if err != nil {
		...
		metrics.BackendDeleteErrorOpsTotal.WithLabelValues("deployment").Inc()

		return err
	}
	metrics.BackendDeleteSuccessOpsTotal.WithLabelValues("deployment").Inc()
	...
	if !data.OnlyTCP {
		...
		if err != nil {
			...
			metrics.BackendDeleteErrorOpsTotal.WithLabelValues("ingress").Inc()

			return err
		}
		metrics.BackendDeleteSuccessOpsTotal.WithLabelValues("ingress").Inc()
	}

	metrics.BackendDeleteOpsTotal.Inc()
